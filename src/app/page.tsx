...
export default function IntroPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 overflow-hidden relative">
          ...
          {showContent && (
            <>
              ...
              >
                ...
                <motion.div
                  className="text-xl md:text-2xl lg:text-3xl font-light text-gray-400 mb-2"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                {/* 타이핑 효과 서브텍스트 */}
                <motion.p
                  className="text-sm md:text-base text-gray-500 mt-4 max-w-md mx-auto"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 1, delay: 2 }}
                >
                  Hyperledger · ZKP · Solidity · 3+ Years Experience
                </motion.p>
              </motion.div>
              ...
              >
                {/* Simple Resume 경로 */}
                <Link href="/ko/simple" className="group">
                  <motion.div
                  ...
                  >
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">Simple Resume</h2>
                    ...
                    <motion.div
                      className="mt-4 text-xs text-gray-600 group-hover:text-gray-400"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ delay: 3 }}
                    >
                ...
                <Link href="/ko" className="group">
                  ...
                  >
                    ...
                    <motion.div
                      className="mt-4 text-xs text-primary-500 group-hover:text-primary-400"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ delay: 3 }}
                    >
              ...
              {/* 언어 선택 힌트 */}
              <motion.div
                className="mt-12 flex gap-4 text-xs text-gray-600"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <span>|</span>
                <Link href="/ko" className="hover:text-gray-400 transition-colors">
                  한국어
                </Link>
              </motion.div>
            </>
      ...
      {/* 하단 장식 */}
      <motion.div
        className="absolute bottom-4 left-1/2 -translate-x-1/2 text-xs text-gray-700"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 4 }}
      >
        Scroll down or choose your path
      </motion.div>
    </div>
  );
}
