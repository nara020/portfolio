            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <p className="text-xs text-gray-400 mb-4">
                  {keyMetrics.tpsOptimization.value} {keyMetrics.tpsOptimization.desc[locale]} · {keyMetrics.papers.value} {keyMetrics.papers.desc[locale]} · {keyMetrics.zkpDecryption.value} {keyMetrics.zkpDecryption.desc[locale]} · {keyMetrics.costSaving.value} {keyMetrics.costSaving.desc[locale]}
                </p>
