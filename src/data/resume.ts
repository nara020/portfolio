...
export const experiences: Experience[] = [
  {
    ...
    achievements: {
      ko: [
        ...
        "── 글로벌 커뮤니케이션 ──",
        "두바이 GITEX 부스 운영 - 블록체인/자사 서비스 영어 상담",
        "해외업체 협력 미팅 주도 및 진행",
        "베트남 프론트엔드 개발자 커뮤니케이션 담당",
      ...
      en: [
        ...
        "Dubai GITEX booth operation - Blockchain/service consulting in English",
        "Led international partner collaboration meetings",
        "Vietnam frontend developer communication lead",
        "Springer ICBTA 2025 international conference English presentation",
      ],
    },
  ...
  },
  {
    ...
    company: { ko: "글로벌 테크 역량 개발", en: "Global Tech Capability Development" },
    role: { ko: "Technical English & 프리랜서 개발", en: "Technical English & Freelance Development" },
    period: "2023.07 ~ 2025.05",
    duration: { ko: "1년 11개월", en: "1 yr 11 mo" },
    description: {
      ko: "블록체인 R&D 중 영어 기술문서/논문 독해의 한계를 체감하고, 글로벌 개발자 생태계 접근을 위한 전략적 투자 결정",
      en: "Strategic investment in English proficiency after experiencing limitations in blockchain R&D technical documentation and global developer ecosystem access",
    },
    achievements: {
      ko: [
        "── Technical English ──",
        "OPIC IH (Intermediate High) 취득",
        "영어 기술문서/API 문서/논문 독해 역량 확보",
        "GitHub/Stack Overflow/공식문서 기반 문제해결 프로세스 체화",
        "── 프리랜서 개발 ──",
        "인바운드 여행 예약 플랫폼 기획 및 백엔드 개발 참여 (Next.js, PostgreSQL)",
        "── 글로벌 마인드셋 ──",
        "호주 워킹홀리데이 + 동남아 6개국 체류 - 다문화 환경 적응력",
      ],
      en: [
        "── Technical English ──",
        "Achieved OPIC IH (Intermediate High)",
        "Acquired English technical documentation/API docs/paper reading skills",
        "Internalized GitHub/Stack Overflow/official docs-based problem-solving workflow",
        "── Freelance Development ──",
        "Participated in inbound travel booking platform (Next.js, PostgreSQL)",
        "── Global Mindset ──",
        "Australia Working Holiday + 6 Southeast Asian countries - Cross-cultural adaptability",
      ],
    },
  ...
  },
  {
    ...
    achievements: {
      ko: [
        "── B-SPACE 플랫폼 ──",
        "Hyperledger Fabric 블록체인 네트워크 3개 독립 구축 (개발/테스트/교육용)",
        "TTA 성능 테스트 통과 (쓰기 400, 읽기 1000 TPS 달성)",
        "Go lang 기반 ChainCode + TypeScript 백엔드 API 개발",
        "한국컴퓨터정보학회 우수논문상 수상 · 서비스 상용화",
        "── IoT 블록체인 메인넷 R&D ──",
        "이더리움 EVM/Layer2/ZK Rollup 기술 분석 및 세미나 주도",
        "영지식증명 메인넷 Mina Protocol 분석",
        "정보처리학회 우수논문상 수상",
        "── 대구 메인넷 ISP ──",
        "대구광역시 NFT 메인넷 프로젝트 - NFT 발행/전송 모듈 설계",
        "TTA 시험검증 방안 설계 · 헬스케어 서비스 설계",
      ],
      en: [
        "── B-SPACE Platform ──",
        "Architected 3 independent Hyperledger Fabric networks (dev/test/education)",
        "Achieved TTA certification (400 TPS write, 1000 TPS read)",
        "Go ChainCode + TypeScript backend API development",
        "KCIS Best Paper Award · Service commercialization",
        "── IoT Blockchain Mainnet R&D ──",
        "Led Ethereum EVM/Layer2/ZK Rollup technology analysis and seminars",
        "Mina Protocol (ZKP mainnet) analysis",
        "KIPS Best Paper Award",
        "── Daegu Mainnet ISP ──",
        "Daegu Metropolitan NFT Mainnet Project - NFT minting/transfer module design",
        "TTA test verification methodology · Healthcare service design",
      ],
    },
