...
export const experiences: Experience[] = [
  {
    ...
    achievements: {
      ko: [
        ...
        "── 국가 R&D 과제 (기술 총괄), ZK/DPP·규제대응 ──",
        "디딤돌 2억원 ZK·DPP 과제 사업계획서 작성 및 협약 완료 → 기술 전담 진행 중",
        "PPWR 30억원 과제 기술 담당 및 외부 협력 컨택",
        "현대건설 API 개발 사업(KISA) 제안 PM, 기획부터 발표까지 전 과정 주도, 사업 수주 성공",
        "IP-R&D 전략지원 사업 선정, PPWR 대응 DPP 플랫폼 특허 포트폴리오 전략, 사업계획서 작성 및 개발 타당성 검토 담당",
      ...
      en: [
        "── B2B Supply Chain Blockchain & ZKP Platform ($1M scale) ──",
        ...
        "── National R&D Projects (Technical Lead), ZK/DPP & Regulatory ──",
        "₩200M Didimdol ZK/DPP R&D: authored proposal, completed agreement → sole technical owner, in progress",
        ...
        "Selected for IP-R&D Strategy Support Program, patent-portfolio strategy for a PPWR-compliant DPP platform; authored the proposal and led technical feasibility review",
