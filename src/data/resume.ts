...
export const experiences: Experience[] = [
  {
    ...
    role: { ko: "Blockchain Infrastructure Engineer", en: "Blockchain Infrastructure Engineer" },
    period: "2025.06 ~ Present",
    duration: { ko: "재직중", en: "Current" },
    current: true,
    description: {
      ko: "Hyperledger Besu 기반 B2B 플랫폼 성능 최적화 설계 및 구현 주도 (27x TPS 향상)",
      en: "Led performance optimization design and implementation for Hyperledger Besu B2B platform (27x TPS improvement)",
    },
    achievements: {
      ko: [
        "── B2B 공급망 블록체인 플랫폼 ──",
        "Hyperledger Besu 서비스 레이어 병목 분석 → 3-Layer 최적화 방법론 설계 (Virtual Threads + Isolation Pattern + Cluster)",
        "27배 성능 최적화 달성 (25→678 TPS), TTA 블록체인 신뢰성 500TPS 벤치마크 통과",
        "ZKP 복호화 병목 분석 (arkworks) → brute-force 이산로그 탐색 제거, 곡선점 직접 연산 재설계 → 65배 최적화 (35초→0.54초)",
        "Solidity 스마트컨트랙트 설계/개발 (UUPS Proxy, ZK 검증, IPFS CID 연동)",
        "TTA 클라우드 적격성 평가 통과 (SaaS 인증)",
        "── 특허 ──",
        "블록체인 관련 특허 가출원 3건, 정식출원 1건 주도",
        "── 아마존/쇼피파이 e-Commerce 플랫폼 ──",
        "2개 외주 개발사 미해결 기술문제 전량 해결 → 계약 규모 35배 확대 (200만원→7,000만원)",
      ...
      en: [
        "── B2B Supply Chain Blockchain Platform ──",
        "Analyzed Hyperledger Besu service layer bottlenecks → Designed 3-Layer optimization (Virtual Threads + Isolation Pattern + Cluster)",
        "Achieved 27x performance optimization (25→678 TPS), Passed TTA Blockchain 500TPS benchmark",
        "ZKP decryption bottleneck analysis (arkworks) → Removed brute-force DLP, redesigned to curve point ops → 65x optimization (35s→0.54s)",
        "Solidity smart contract design/development (UUPS Proxy, ZK verification, IPFS CID)",
        "Passed TTA Cloud Qualification (SaaS certification)",
        "── Patents ──",
        "Led blockchain patent initiatives: 3 provisional + 1 formal application",
        "── Amazon/Shopify e-Commerce Platform ──",
        "Resolved all issues from 2 vendors → 35x contract expansion ($1.5K→$54K)",
  ...
  },
  {
    ...
    company: { ko: "전략적 글로벌 역량 투자", en: "Strategic Global Capability Investment" },
    role: { ko: "Technical English & Freelance Development", en: "Technical English & Freelance Development" },
    period: "2023.07 ~ 2025.05",
    duration: { ko: "1년 11개월", en: "1 yr 11 mo" },
    description: {
      ko: "글로벌 개발자 생태계 접근 및 영문 기술문서 기반 개발 역량 확보를 위한 전략적 투자 기간",
      en: "Strategic investment period for global developer ecosystem access and English technical documentation capabilities",
    },
    achievements: {
      ko: [
        "── Technical English ──",
        "OPIC IH (Intermediate High) 취득 → 영문 기술문서/API/논문 독해 역량 확보",
        "── Side Projects ──",
        "인바운드 여행 예약 플랫폼 (Next.js, PostgreSQL, WhatsApp 연동)",
        "Audio/PDF to Text 추출 프로그램 (Tesseract OCR, OpenCV)",
        "암호화폐 시세 분석 웹 (Flask, Binance API)",
        "AI 웹 서비스 개발 (Teachable Machine, 웹 크롤링)",
        "── Global Exposure ──",
        "호주 워킹홀리데이 + 동남아 6개국 - 다문화 커뮤니케이션 역량",
      ],
      en: [
        "── Technical English ──",
        "OPIC IH (Intermediate High) → English technical docs/API/paper reading capability",
        "── Side Projects ──",
        "Inbound travel booking platform (Next.js, PostgreSQL, WhatsApp)",
        "Audio/PDF to Text extraction (Tesseract OCR, OpenCV)",
        "Crypto price analysis web (Flask, Binance API)",
        "AI web services (Teachable Machine, web crawling)",
        "── Global Exposure ──",
        "Australia Working Holiday + 6 SE Asian countries - Cross-cultural communication",
      ],
    },
  ...
  },
  {
    ...
    role: { ko: "Blockchain Developer", en: "Blockchain Developer" },
    period: "2022.02 ~ 2023.06",
    duration: { ko: "1년 5개월", en: "1 yr 5 mo" },
    description: {
      ko: "Hyperledger Fabric 기반 블록체인 플랫폼 구축 및 상용화 (B-SPACE)",
      en: "Hyperledger Fabric blockchain platform development and commercialization (B-SPACE)",
    },
    achievements: {
      ko: [
        "── B-SPACE 블록체인 플랫폼 ──",
        "Hyperledger Fabric 네트워크 3개 독립 설계/구축 (개발·테스트·교육용)",
        "TTA 성능 인증 통과 (쓰기 400, 읽기 1000 TPS) → 서비스 상용화 완료",
        "Go ChainCode + TypeScript 백엔드 API 설계/개발",
        "한국컴퓨터정보학회 우수논문상 수상",
        "── IoT 블록체인 메인넷 R&D ──",
        "이더리움 EVM/Layer2/ZK Rollup 기술 분석 및 세미나 주도",
        "정보처리학회 우수논문상 수상 (블록체인 기반 확률제어 시스템)",
        "── 대구 메인넷 ISP ──",
        "대구광역시 NFT 메인넷 - NFT 발행/전송 모듈 설계",
      ],
      en: [
        "── B-SPACE Blockchain Platform ──",
        "Designed & deployed 3 independent Hyperledger Fabric networks (dev/test/education)",
        "TTA performance certified (400 write, 1000 read TPS) → Service commercialized",
        "Go ChainCode + TypeScript backend API design/development",
        ...
        "── Daegu Mainnet ISP ──",
        "Daegu Metropolitan NFT Mainnet - NFT minting/transfer module design",
      ],
    },
